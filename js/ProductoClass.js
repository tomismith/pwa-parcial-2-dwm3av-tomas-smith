class Producto{
  ...
  imprimirProducto() {
    ...
    divCard.className = "card  shadow-sm mx-auto bg-light";
    ...
    botonCompraCardBody.className = "btn btn-secondary w-100 mb-3 addCart";
    ...
    botonDetalleCardBody.className = "btn btn-secondary w-100";
  ...
  imprimirModal(producto){
    ...
    let botonCompraCardBody = document.createElement("button");
    botonCompraCardBody.className = "btn btn-secondary  my-3 addCart";
    botonCompraCardBody.innerText = "Agregar al carrito";
    botonCompraCardBody.setAttribute("onclick",`agregarAlCarrito(${this.id})`);
